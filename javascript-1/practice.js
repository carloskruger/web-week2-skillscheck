...
//Code here
function lovesCodeChecker(x){if (x) {return true} else {return false}}
//////////////////PROBLEM 6////////////////////
...
//Code Here
const me = { firstName: "Carlos", state: "New York", age: 60, greeter: function(){ return `Hello! My name is ${this.firstNamwe} and I live in ${this.state}`}}
//////////////////PROBLEM 12////////////////////
...
// Code Here
const doubled = myNumbers.map((elem) => elem * 2)
//////////////////PROBLEM 15////////////////////
...
// Code Here
const forTheLoveOfGeorge = notGeorge.map(elem => elem = 'George')
//////////////////PROBLEM 19////////////////////
...
// Code Here
let enemies = []
enemies = people.filter(elem => elem['friend'] == false)
//////////////////PROBLEM 20////////////////////
